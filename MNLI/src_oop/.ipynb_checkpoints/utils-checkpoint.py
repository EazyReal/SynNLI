...
def text2graph(text: str, parser: Union[Pipeline, BiaffineDependencyParserPredictor], parser_name: str) -> Data:
    ...
    if parser_name == "allennlp":
        ...
        return doc2graph_stanza(parser(text))
    else:
        logging.critical("handler fail")
        return None
...
def text2graph_stanza(text : str, nlp : Pipeline):
    """
    text2doc by Stanza
    doc2graph by utils.doc2graph 
    """
    return doc2graph_stanza(nlp(text))
