...
class SynNLI_Model(nn.Module):
    ...
    def __init__(self, nli_config=config.nli_config, pretrained_embedding_tensor=None):
        ...
        self.bilstm_emd = nn.LSTM(input_size=d, hidden_size=d, num_layers=2, bidirectional=True, batch_first=True, dropout=0)
        self.bilstm_cmp = nn.LSTM(input_size=d, hidden_size=d, num_layers=2, bidirectional=True, batch_first=True, dropout=0)
        # encoder
