...
class GATConv(MessagePassing):
    ...
    def __init__(self,
                 ...
                 bias: bool = True,
                 # remove **kwargs for avoid passing **kwargs
                ): 
        super(GATConv, self).__init__(aggr='add', node_dim=0)# remove **kwargs for avoid passing **kwargs
    ...
    def forward(self, x: Union[Tensor, OptPairTensor], edge_index: Adj,
                size: Size = None, return_attention_weights=None, **kwargs):
