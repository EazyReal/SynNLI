...
@TokenEmbedder.register("elmo_token_embedder_with_mask", exist_ok=True)
class ElmoTokenEmbedderWithMask(TokenEmbedder):
    """
    ...
    def forward(self, elmo_tokens: torch.Tensor, word_inputs: torch.Tensor = None, mask: torch.Tensor=None) -> torch.Tensor:
        """
        # Parameters
